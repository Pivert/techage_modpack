...
if minetest.global_exists("techage") then
	...
	local content = dofile(MP.."/manual_FR.lua")
...
elseif minetest.global_exists("doclib") then
	...
	doclib.create_manual("signs_bot", "FR", settings)
	local content = dofile(MP.."/manual_FR.lua")
	doclib.add_to_manual("signs_bot", "FR", content)
	...
	minetest.register_node("signs_bot:manuel", {
		description = "Manuel de Signs Bot (FR)",
		inventory_image = "doclib_book_inv.png",
		tiles = {
			-- up, down, right, left, back, front
			"doclib_book.png",
		...
		after_place_node = function(pos, placer, itemstack)
			minetest.get_meta(pos):set_string("infotext", "Manuel de Signs Bot (FR)")
			minetest.get_meta(pos):set_string("formspec", doclib.formspec(pos, "signs_bot", "FR"))
		end,
		...
		on_receive_fields = function(pos, formname, fields, player)
			...
			minetest.get_meta(pos):set_string("formspec", doclib.formspec(pos, "signs_bot", "FR", fields))
		end,
